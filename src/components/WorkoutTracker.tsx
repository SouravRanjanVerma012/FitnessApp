...
export const WorkoutTracker = () => {
  ...
  const saveAIWorkoutPlan = async (workoutPlan: any) => {
    try {
      const response = await fetch(`${apiService.baseURL}/workout-plans`, {
        method: 'POST',
        headers: {
  ...
  const saveWorkout = async () => {
    ...
    try {
      ...
      const res = await fetch(`${apiService.baseURL}/workouts`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${apiService.getToken()}`,
  ...
  const sendRecFeedback = async (rating: 'easy' | 'just_right' | 'hard') => {
    try {
      await fetch(`${apiService.baseURL}/recommendation/feedback`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${apiService.getToken()}`,
