...
import { testNetworkConnection, findWorkingConnection, getBaseURL } from '../lib/networkConfig';
...
const LoginScreen: React.FC<LoginScreenProps> = ({ onSwitchToSignup }) => {
  ...
  const handleDemoLogin = async () => {
    ...
    try {
      ...
      const testResponse = await fetch(`${getBaseURL()}/health`);
      ...
      try {
        ...
        const testResponse2 = await fetch(`${getBaseURL()}/health`);
